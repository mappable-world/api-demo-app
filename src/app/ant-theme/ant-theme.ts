...
const antTheme: ThemeConfig = {
	...
	token: {
		...
		colorPrimary: '#eefd7d',
		colorInfo: '#eefd7d',
		colorPrimaryTextActive: '#050d33',
		colorPrimaryText: '#050d33',
		colorPrimaryTextHover: '#050d33',
		colorPrimaryActive: '#f8ffa6',
		colorPrimaryBorderHover: '#f8ffa6',
		colorPrimaryBorder: '#eefd7d',
		colorPrimaryBgHover: '#f8ffa6',
		colorPrimaryBg: '#eefd7d',
		colorText: '#050D33'
	},
	components: {
		Layout: {
